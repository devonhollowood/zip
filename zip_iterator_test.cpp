...
BOOST_AUTO_TEST_CASE(constructor_test) {
    vector<int> v = {0,1,2};
    zip_iterator<vector<int>::iterator> itr_a(v.begin());
    zip_iterator<vector<int>::iterator> itr_b(itr_a);
    zip_iterator<vector<int>::iterator> itr_c = itr_a;
...
BOOST_AUTO_TEST_CASE(equality_test) {
    vector<int> v = {0,1,2};
    zip_iterator<vector<int>::iterator> itr_a(v.begin());
    zip_iterator<vector<int>::iterator> itr_b(v.begin());
...
BOOST_AUTO_TEST_CASE(rvalue_deref_test) {
    vector<int> v = {0};
    zip_iterator<vector<int>::iterator> itr(v.begin());
...
BOOST_AUTO_TEST_CASE(iteration_test) {
    ...
    zip_iterator<vector<int>::iterator> itr(v.begin());
    zip_iterator<vector<int>::iterator> end(v.end());
    size_t i = 0;
    for(; itr!=end; ++itr, ++i){
        if(i>=v.size()){
...
BOOST_AUTO_TEST_CASE(constructor_test) {
    ...
    zip_iterator<vector<int>::iterator, vector<char>::iterator>
        itr_a(v1.begin(), v2.begin());
    zip_iterator<vector<int>::iterator, vector<char>::iterator> itr_b(itr_a);
    zip_iterator<vector<int>::iterator, vector<char>::iterator> itr_c = itr_a;
    BOOST_CHECK(itr_b==itr_c);
}
